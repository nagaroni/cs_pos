...
First Exercise,The First Exercise piece of cake!,Ruby,http://codezombi.com/first-exercise
...
Crazy one,You're not able to do that,Ruby,http://rubyjedi/super-hard"
    ...
    expect(challenges).to receive(:create)
      .with(title: 'First Exercise', description: 'The First Exercise piece of cake!')
    expect(challenges).to receive(:create)
